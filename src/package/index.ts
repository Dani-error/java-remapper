...
let remapFunc: ((b: Uint8Array, mappings: MappingSet) => Promise<Uint8Array>) | null = null;

export const remap = async (b: Uint8Array, mappings: MappingSet): Promise<Uint8Array> => {
    if (!remapFunc) {
        // @ts-expect-error
